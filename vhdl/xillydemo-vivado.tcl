# KalmanProject project generation script for Vivado 2014.4 and up

set origin_dir [file dirname [info script]]

if {[string first { } $origin_dir] >= 0} {
send_msg_id KalmanProject-1 error "The path to the the project directory contains white space(s): \"$origin_dir\". This is known to cause problems with Vivado. Please move the project to a path without white spaces, and try again."
}

set proj_name KalmanProject
...
set_property "top" "KalmanProject" $obj

# Add files to 'sources_1' fileset
set obj [get_filesets sources_1]
set files [list \
 $origin_dir/src/KalmanProject.vhd \
...
add_files -fileset $obj -norecurse $essentials_dir/KalmanProject.xdc
